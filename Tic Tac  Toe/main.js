//I've tried to explain each JavaScript line with comments.... 
...
selectBtnX.onclick = ()=>{
    selectBox.classList.add("hide"); //hide select box yaany ki yenzel al selectBtnX wateha yetn7a 'selectBox'
    playBoard.classList.add("show"); //show the playboard section  o baad yodh7er hetha 'playBoard'
}
